import { r as reactExports } from "./worker-entry-D6sA9fSD.js";
import { c as clsx } from "./clsx-DgYk2OaC.js";
import { i as isNumber, an as adaptEventHandlers, ac as svgPropertiesNoEvents, P as DefaultZIndexes, ao as isClipDot, ap as svgPropertiesAndEventsFromUnknown, Z as ZIndexLayer, L as Layer, a1 as useAppSelector, a7 as selectActiveTooltipIndex, aq as useActiveTooltipDataPoints, k as isNullish, a8 as svgPropertiesNoEventsFromUnknown, p as createSelector, v as selectChartLayout, x as selectChartDataWithIndexesIfNotInPanoramaPosition3, ar as selectChartBaseValue, z as selectAxisWithScale, y as selectXAxisIdFromGraphicalItemId, A as selectYAxisIdFromGraphicalItemId, B as selectTicksOfGraphicalItem, o as getStackSeriesIdentifier, as as isCategoricalAxis, D as getBandSizeOfAxis, E as selectUnfilteredCartesianItems, I as selectStackGroups, O as propsAreEqual, r as resolveDefaultProps, Q as useIsPanorama, T as RegisterGraphicalItemId, U as SetLegendPayload, V as SetCartesianGraphicalItem, N as getNormalizedStackId, W as getTooltipNameProp, X as SetTooltipEntrySettings, Y as noop, $ as useChartLayout, at as useChartName, _ as useNeedsClip, au as usePlotArea, a3 as GraphicalItemClipPath, a2 as getValueByDataKey, av as getCateCoordinateOfLine, a as useAnimationId, aw as useCartesianChartLayout, J as JavascriptAnimate, d as interpolate, ae as isNan, aa as LabelListFromLabelProp, ab as CartesianLabelListContextProvider, s as svgPropertiesAndEvents, C as Curve, n as isWellBehavedNumber, ag as CartesianChart, ah as arrayTooltipSearcher } from "./CartesianChart-CjxWrusz.js";
function _extends$2() {
...
var Dot = (props) => {
  ...
  if (isNumber(cx) && isNumber(cy) && isNumber(r)) {
    return /* @__PURE__ */ reactExports.createElement("circle", _extends$2({}, svgPropertiesNoEvents(props), adaptEventHandlers(props), {
...
function DotItem(_ref) {
  ...
  return /* @__PURE__ */ reactExports.createElement(Dot, _extends$1({}, props, {
...
function Dots(_ref3) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    zIndex
  }, /* @__PURE__ */ reactExports.createElement(Layer, _extends$1({
    className
  }, layerProps), dots));
}
