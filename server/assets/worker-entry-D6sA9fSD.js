...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BOyw1Epp.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C2dGhf-y.js").then((n2) => n2.c),
...
var ROUTER_BASEPATH = "cosumar-agro-hub-";
var SERVER_FN_BASE = "/cosumar-agro-hub-/_serverFn/";
