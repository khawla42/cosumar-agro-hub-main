  ...
  useEffect(() => {
    if (socket) {
      const handleNewLog = (newLog: any) => {
        setLogsList((prev) => [newLog, ...prev].slice(0, 100));
      };
          ...
          <div className="rounded-xl border border-destructive/20 bg-destructive/5 p-4 flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-destructive/80 mt-1">
                De multiples tentatives de connexion échouées ont été détectées depuis les adresses
                IP suivantes :
            ...
            <tbody>
              {filtered.map((l) => (
                ...
                >
                  ...
                  <td className="px-5 py-4">
                    <div className="text-sm text-muted-foreground capitalize">{l.role}</div>
                  </td>
